...
#       [root@milkv-duo]~/milkv/duo# bash ./ex01_led_htserv.sh
...
#       [root@milkv-duo]~/milkv/duo# curl http://192.168.42.1:8080/?L=1
#   制御できないときは、何度か試してください。
# 4.LEDを消灯する場合は下記です。
#       [root@milkv-duo]~/milkv/duo# curl http://192.168.42.1:8080/?L=0
# 5.プログラムを停止するには[Ctrl]+[C]を押してください
#   止まらないときは下記を実行してください(他のbash処理も止まります)
#       [root@milkv-duo]~/milkv/duo# kill `pidof bash`
################################################################################
# 応用①：インターネット・ブラウザから制御
